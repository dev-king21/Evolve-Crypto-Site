  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "vx-row" }, [
        ...
        _c(
          "div",
          { staticClass: "vx-col md:w-2/3 lg:w-2/3 xl:w-2/3 w-full mb-base" },
          [
            _c("vx-card", { staticClass: "flex flex-col w-full h-full" }, [
              _c(
                "div",
                { staticClass: "flex w-full justify-between" },
                [
                  _c("h2", { staticClass: "mb-1 font-bold" }, [
                    _vm._v("Teams Properties")
                  ]),
                  _vm._v(" "),
                  _c("change-time-duration-dropdown", {
                    staticClass: "self-end"
              ...
              _vm.supportTracker.analyticsData
                ? _c("div", [
                    _c("div", { staticClass: "vx-row text-center mt-4" }, [
                      _c(
                        "div",
                        {
                          staticClass:
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "flex flex-row justify-between px-8 pb-4 mt-6"
                      },
